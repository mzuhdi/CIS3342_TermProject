<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentClasses.aspx.cs" Inherits="TermProject.StudentClasses" %>
                    ...
                    <table id="Table1" border="0" cellpadding="5" cellspacing="0"
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <asp:Label ID="lblProfessor" runat="server" Style="font-size: large" Text='<%# DataBinder.Eval(Container.DataItem, "FirstName") %>'></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="style1">
